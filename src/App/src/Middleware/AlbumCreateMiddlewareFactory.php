...
class AlbumCreateMiddlewareFactory
{
    public function __invoke(ContainerInterface $container) : AlbumCreateMiddleware
    {
        $router          = $container->get(RouterInterface::class);
        $albumRepository = $container->get(AlbumRepositoryInterface::class);
        $inputFilter     = $container->get(AlbumInputFilter::class);
        
        return new AlbumCreateMiddleware($router, $albumRepository, $inputFilter);
    }
}
