...
return [
    'dependencies' => [
        'factories' => [
            App\Handler\AlbumDeleteHandler::class => App\Handler\AlbumDeleteHandlerFactory::class,
            App\Middleware\AlbumDeleteMiddleware::class => App\Middleware\AlbumDeleteMiddlewareFactory::class,
        ],
    ],
];
